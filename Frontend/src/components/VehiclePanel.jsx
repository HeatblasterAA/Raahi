...
const VehiclePanel = (props) => {
    return (
        <div>
            ...
            }} className=' flex mb-2 p-3 z-10 items-center border-2 bg-[#f4f4f4] active:border-[#141414] rounded-xl  justify-between'>
            ...
            }} className=' flex mb-2 p-3 z-10 items-center border-2 bg-[#f4f4f4] active:border-black rounded-xl  justify-between'>
